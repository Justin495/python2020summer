# -*- coding: utf-8 -*-
"""
Created on Sat Jul 11 15:44:47 2020
...
class Excercise9 ( wx.Frame ):

    def __init__( self, parent ):
        wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"USGS Discharge Data App", pos = wx.DefaultPosition, size = wx.Size( 1400,800 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
        ...
        self.m_staticText1 = wx.StaticText( self, wx.ID_ANY, u"USGS (Discharge): Station ID", wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        self.OutFolder = wx.StaticText( self, wx.ID_ANY, u"Output Folder", wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        self.m_radioBox1 = wx.RadioBox( self, wx.ID_ANY, u"Time Frame", wx.DefaultPosition, wx.DefaultSize, m_radioBox1Choices, 1, wx.RA_SPECIFY_COLS )
        ...
        self.m_radioBox2 = wx.RadioBox( self, wx.ID_ANY, u"Statistics", wx.DefaultPosition, wx.DefaultSize, m_radioBox2Choices, 1, wx.RA_SPECIFY_COLS )
        ...
        # Connect Events
        self.download.Bind( wx.EVT_BUTTON, self.USGS_download_data )
        self.m_radioBox1.Bind( wx.EVT_RADIOBOX, self.changeFreq )
        self.m_radioBox2.Bind( wx.EVT_RADIOBOX, self.changeStatistics )
    ...
    def USGS_download_data( self, event ):
...
# Virtual event handlers, overide them in your derived class
    ...
    def changeStatistics( self, event):
        self.axes.clear()
        global sID
        sID = event.GetInt()
        print(sID)
